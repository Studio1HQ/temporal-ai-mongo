...
class Config:
    ...
    # OpenAI (or any OpenAI wire-protocol endpoint: Nebius, vLLM, LM Studio, ...)
    OPENAI_API_KEY = os.getenv("OPENAI_API_KEY")
    OPENAI_BASE_URL = os.getenv("OPENAI_BASE_URL", "https://api.openai.com/v1/")
    OPENAI_MODEL = os.getenv("OPENAI_MODEL", "gpt-4o-mini")
    OPENAI_EMBEDDING_MODEL = os.getenv("OPENAI_EMBEDDING_MODEL", "text-embedding-3-small")

    LLM_PROVIDER = os.getenv("LLM_PROVIDER", "bedrock")  # Options: "bedrock", "groq", "openai"
    EMBEDDING_PROVIDER = os.getenv("EMBEDDING_PROVIDER", "voyage")  # Options: "voyage", "openai", "cohere"
    ...
    VECTOR_DIMENSION = int(os.getenv("VECTOR_DIMENSION", "1024"))  # 1024 for Voyage/Cohere, 4096 for Qwen3-Embedding-8B
